...
constexpr auto YS2_EXE_CSV_PATH = "EXETranslation\\ys2_exe_text.csv";
...
constexpr auto YS_FONT_SYTLE_DIA = "text2.ini";

constexpr auto YS_CSV_COL_NUM = 7;

constexpr auto YS_CSV_COL_NUM_WITH_EXPANDADDRESS = 8;
